...
jurisdiction: "oregon"
id: ors-196.795
title: "Streamlining process for administering state removal or fill permits; application for state program general permit; periodic reports to legislative committee"
doc_type: statute
...
# Streamlining process for administering state removal or fill permits; application for state program general permit; periodic reports to legislative committee (ORS 196.795)

## At a glance

ORS 196.795 — Streamlining process for administering state removal or fill permits; application for state program general permit; periodic reports to legislative committee. Chapter 196 (Chapter 196), 2025 Edition.
