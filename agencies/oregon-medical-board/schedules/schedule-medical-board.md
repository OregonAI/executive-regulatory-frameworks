...
conversion_notes: 'Text extracted from the source PDF with pypdf 6.14.2 (per-page extract_text), 10 pages.
  Stripped repeated running-header lines: "Edition: April 2023 Schedule Number: 2023-0002"; "Oregon State
  Archives"; "Records Retention Schedule". Stripped 9 bare page-number line(s). Only lines that BOTH repeat
