...
source_sha256: "2639f0323ae43a7dd42a1ba7af703428d9c98c09dcdcd2f29348aab88eb6b470"
effective_date: "2023-05-30"  # <!-- TODO: human verification required: source changed; re-transcribe effective/reviewed/version dates from the new source -->
last_reviewed: null
...
SUBJECT:          Criminal Offender Information
                  Access
...
APPROVED:         Jim Diegel                                              DATE: JULY 6, 2026
                                James Diegel (Jul 6, 2026 13:33:24 PDT)
...
SELECT ONE:     ☐ New Policy                                ☒ Policy Revision
 ...
 I. PURPOSE AND APPLICABILITY
       ...
       A. This policy establishes Oregon State Hospital (OSH) parameters for access
 ...
 II.   POLICY
   A. OSH requires access to criminal history information to perform its designated
      functions, including:
       1. Providing secure evaluation and treatment plans, services, and settings for
          persons committed to the Oregon Health Authority (OHA);
       ...
       5. Screening applicants for Volunteer Services, contract employees, and Service
          Providers who may have direct contact with patients or adults in custody.
   B. OSH restricts the use of criminal offender information in accordance with set
      guidelines. Information received from the Oregon State Police, including Law

Subject: Criminal Offender Information                           Policy Number: 8.004
Access
Date: July 6, 2026
                                                                           P AGE 2 OF 4
     ...
     1. In the event that a patient's criminal offender information is requested, staff
        shall adhere to OSH’s policies and procedures regarding the release of
        information.
     2. LEDS reports obtained for the purposes stated in this policy may not be
        released by OSH.
     3. LEDS reports or documents containing LEDS information shall be maintained
  ...
  E. Criminal history information run in the Oregon Criminal History & Abuse Records
     Database System (ORCHARDS) for employment, volunteering, or internship may
     be used only as a reference to identify the source of original records or in direct
  ...
  F. Criminal offender information relating to a subject individual for employment or a
     ...
     1. The applicant shall sign a consent form authorizing the criminal offender
        information check.
 ...
 Date: July 6, 2026
        ...
        2. A refusal to sign a consent form for ORCHARDS- criminal records review or a
           false swearing to an arrest or non-conviction of a crime may be cause to deny
    ...
    G. Any staff shall notify the office of Human Resources (HR) manager within five
    ...
    I. Staff performing designated functions for OSH must complete CJIS security
       training before accessing LEDS reports and shall recertify every year for
       continued access.
    J. State Hospital (OSH) follows all applicable regulations, including federal and
