...
doc_type: schedule
citation: Human Services - Office of Training, Investigation and Safety — Oregon Special Records Retention
  Schedule
...
conversion_notes: 'Text extracted from the source PDF with pypdf 6.14.2 (per-page extract_text), 5 pages.
  Stripped repeated running-header lines: "Edition: April 2026 Schedule Number: 2026-0003"; "Oregon State
  Archives"; "Records Retention Schedule". Stripped 4 bare page-number line(s). Only lines that BOTH repeat
