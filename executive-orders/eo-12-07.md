...
conversion_notes: "text recovered via OCR (ocrmypdf/tesseract); no page furniture detected; corroborated after the fact by a further independent engine (paddleocr PP-OCRv6) reading the original scan, agreeing on 98% of the committed word sequence and 90% of the 37 figures, 97% dictionary-recognizable; the committed text is the original extraction and was not altered by corroboration; NOT human-verified"
