...
jurisdiction: "oregon"
id: orconst-art-xv-sec-4
title: "Regulation of lotteries; state lottery; use of net proceeds from state lottery"
doc_type: constitutional_provision
citation: "Or. Const. Art. XV, sec. 4"
...
# Regulation of lotteries; state lottery; use of net proceeds from state lottery (Or. Const. Art. XV, sec. 4)

## At a glance

Or. Const. Art. XV, sec. 4 — Regulation of lotteries; state lottery; use of net proceeds from state lottery. Article XV (MISCELLANEOUS), Oregon Constitution, in effect following the approval of amendments and revisions on November 5, 2024.
...
(9) of this section, lotteries and the sale of lottery tickets, for any purpose whatever, are prohibited, and the Legislative Assembly shall prevent the same by penal laws.
...
(6) The Legislative Assembly may by law appropriate, allocate or transfer any portion of the principal of the education stability fund created under paragraph (d) of subsection
...
(7) The Legislative Assembly may by law prescribe the procedures to be used and identify the persons required to make the forecasts described in subsection
