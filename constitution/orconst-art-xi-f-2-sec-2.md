...
jurisdiction: "oregon"
id: orconst-art-xi-f-2-sec-2
title: "Definitions"
doc_type: constitutional_provision
citation: "Or. Const. Art. XI-F(2), sec. 2"
...
# Definitions (Or. Const. Art. XI-F(2), sec. 2)

## At a glance

Or. Const. Art. XI-F(2), sec. 2 — Definitions. Article XI-F(2) (VETERANS' BONUS), Oregon Constitution, in effect following the approval of amendments and revisions on November 5, 2024.
