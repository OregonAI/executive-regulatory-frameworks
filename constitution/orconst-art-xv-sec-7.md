...
jurisdiction: "oregon"
id: orconst-art-xv-sec-7
title: "Officers not to receive fees from or represent claimants against state"
doc_type: constitutional_provision
citation: "Or. Const. Art. XV, sec. 7"
...
# Officers not to receive fees from or represent claimants against state (Or. Const. Art. XV, sec. 7)

## At a glance

Or. Const. Art. XV, sec. 7 — Officers not to receive fees from or represent claimants against state. Article XV (MISCELLANEOUS), Oregon Constitution, in effect following the approval of amendments and revisions on November 5, 2024.

## Full text

Section 7. Officers not to receive fees from or represent claimants against state. No State officers, or members of the Legislative Assembly, shall directly or indirectly receive a fee, or be engaged as counsel, agent, or Attorney in the prosecution of any claim against this State.—
