...
jurisdiction: "oregon"
id: orconst-art-xi-g-sec-2
title: "Bonds"
doc_type: constitutional_provision
citation: "Or. Const. Art. XI-G, sec. 2"
...
# Bonds (Or. Const. Art. XI-G, sec. 2)

## At a glance

Or. Const. Art. XI-G, sec. 2 — Bonds. Article XI-G (HIGHER EDUCATION INSTITUTIONS AND ACTIVITIES; COMMUNITY COLLEGES), Oregon Constitution, in effect following the approval of amendments and revisions on November 5, 2024.

## Full text

Section 2. Bonds. Bonds issued pursuant to this Article shall be the direct general obligations of the state and shall be in such form, run for such periods of time, and bear such rates of interest as the Legislative Assembly provides. Such bonds may be refunded with bonds of like obligation. [Created through H.J.R. 8, 1963 (s.s.), and adopted by the people May 15, 1964]
