...
# `name` and `oar_name` hold identical bytes on 185 of the 189 committed rows, differing only
# on the four whose statutory name has been established (#168), so a search proof that reads
# the committed registry passes whichever field the matcher reads on all but four of them. Both names
